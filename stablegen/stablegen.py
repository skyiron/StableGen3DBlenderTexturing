...
class StableGenPanel(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        if prefs and prefs.preferences.enable_debug:
            ...
            row = debug_box.row()
            row.operator("stablegen.debug_coverage_heatmap", text="Coverage Heatmap", icon="COLORSET_01_VEC")
            if width_mode == 'narrow':
                row = debug_box.row()
